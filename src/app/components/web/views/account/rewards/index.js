                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="user-dt">
                                    ...
                                    <h4>Johe Doe</h4>
                                    <p>+91999999999<Link to="#"><i className="uil uil-edit" /></Link></p>
                            ...
                            <div className="col-lg-3 col-md-4">
                                <div className="left-side-tabs">
                                    <div className="dashboard-left-links">
                                        <Link to="/account/view" className="user-item"><i className="uil uil-apps" />Overview</Link>
                                        ...
                                        {/* <Link to="/account/rewards" className="user-item active"><i className="uil uil-gift" />My Rewards</Link> */}
