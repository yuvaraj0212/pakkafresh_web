...
class Singleproduct extends Component {
    ...
    async componentDidMount() {
        ...
        this.setState({ product: list.result })
    }
    render() {
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <Link to="/"><strong><span className="mdi mdi-home" /> Home</strong></Link> <span className="mdi mdi-chevron-right" /> <Link to="#">Fruits &amp; Vegetables</Link> <span className="mdi mdi-chevron-right" /> <a to="#">Fruits</a>
                            </div>
                        </div>
                    </div>
                </section>
                                    ...
                                    <div className="col-md-6">
                                        <div className="shop-detail-right">
                                            ...
                                            <div className="pdp-product__new-price">
                                                ...
                                                <span className="pdp-product__price--new">&#x20B9;{product.price - (product.price/100)}</span>
