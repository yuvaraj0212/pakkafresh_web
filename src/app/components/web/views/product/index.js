...
class Productview extends Component {
    ...
    async handleFilterCategory(row) {
        ...
        if (category) {
            this.setState({ categorybyproduct: category.result, isloaded: true, toggle: true })
        } else {
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <Link to="/"><strong><span className="mdi mdi-home" /> Home</strong></Link> <span className="mdi mdi-chevron-right" /> <a to="#">Fruits</a>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-9">
                                <div className="shop-head">
                                    <Link to="/"><span className="mdi mdi-home" /> Home</Link>  <span className="mdi mdi-chevron-right" /> <a to="#">Fruits</a>
