...
class Shopdetails extends Component {
    ...
    async componentDidMount() {
        ...
        try {
            ...
            if (p) {
                this.setState({ list: p.result, isloaded: true });
            }
        } catch (e) {
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <Link to="/"><strong><span className="mdi mdi-home" /> Home</strong></Link> <span className="mdi mdi-chevron-right" /> <Link to="#">Fruits</Link>
                            </div>
                        </div>
                    </div>
                </section>
