...
class Checkout extends Component {
    ...
    async componentDidMount() {
        ...
        if (!email) {
            ...
            if (user) {
                console.log(user);
                this.setState({ customer: user.username, email: user.email,phone:user.phone })
            }
        }
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <Link to="/"><strong><span class="mdi mdi-home"></span> Home</strong></Link> <span class="mdi mdi-chevron-right"></span> <a >Checkout</a>
                            </div>
                        </div>
                    </div>
                </section>
                                        ...
                                        <div className="card checkout-step-one">
                                            <div className="card-header" id="headingOne">
                                                <h5 className="mb-0">
                                                    ...
                                                    <div className="_2jDL7w"><div><span className="dNZmcB">{customer.username} </span><span className="_3MeY5j">{customer.email}</span></div></div>
                                                </h5>
                                            </div>
                                        </div>
